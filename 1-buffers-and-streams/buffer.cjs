...
editableBuffer[1] = 72;
editableBuffer[2] = 81;
console.log(editableBuffer.toString("utf8"));

// it's possible to edit outside buffer index without changing
editableBuffer[22] = 81;
...
console.log("Subarray 3:", splitBuffer.toString());
